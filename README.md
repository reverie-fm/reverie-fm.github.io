...
The admin account is `justin` (change the `ADMIN_USERNAME` constant in `home.html` to your username). Admins get an extra section in Settings to **edit any user's username or password, or delete their account**.
